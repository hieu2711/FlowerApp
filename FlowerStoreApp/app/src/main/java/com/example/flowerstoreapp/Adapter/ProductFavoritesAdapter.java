...
public class ProductFavoritesAdapter extends RecyclerView.Adapter<ProductFavoritesAdapter.ProductViewHolder> {

    public ProductFavoritesAdapter(List<Products> listProducts, Context context) {
    ...
    @NonNull
    @Override
    public ProductFavoritesAdapter.ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item,parent,false);
        return new ProductViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ProductFavoritesAdapter.ProductViewHolder holder,@SuppressLint("RecyclerView") int position) {
